    ...
    return (
        <Layout pageTitle="Signup">
            ...
            <form action='/api/signup' method='POST'>
                ...
                <input minLength="3" name="lt_username" id="lt_username" type="text" placeholder='username' required></input><br/>
                <input minLength="3" name="gfg_username" id="gfg_username" type="text" placeholder='username' required></input><br/>
                <input minLength="3" name="cc_username" id="cc_username" type="text" placeholder='username' required></input><br/> 
                {/* <input minLength="5" name="passwordagain" id="passwordagain" type="password" placeholder='password again' required></input><br /> */}
